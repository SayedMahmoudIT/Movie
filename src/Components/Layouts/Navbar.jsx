...
export default function Navbar() {
  ...
  console.log(lang);
  const source = Localization[lang];
  //console.log(source);
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <NavLink to="/" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white" aria-current="page">{source.home}</NavLink>
                <NavLink to="/movie" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">{source.movie}</NavLink>
                ...
                <button type='button' onClick={ChangeLang} className="rounded-md px-3 py-2 text-sm font-medium bg-amber-200 text-gray-700">{lang==='ar'?'English':'Arabic'}</button>
